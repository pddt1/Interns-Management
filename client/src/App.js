    ...
    <div>
      <Navbar variant="dark" bg="dark" expand="lg">
        <Container fluid>
          ...
          {currentUser.username?(<Navbar.Collapse id="navbar-dark-example">
            <Nav style={{paddingLeft:"100%"}}>
              <NavDropdown
                ...
                className="drop"
              >
                <NavDropdown.Header>Welcome, {currentUser.username}</NavDropdown.Header>
                <NavDropdown.Item href={"user/"+currentUser.id}>Profile</NavDropdown.Item>
                <NavDropdown.Divider />
      ...
      <div className="container mt-3">
        <Routes>
          <Route exact path="/" element={currentUser.username?<Home/>:<Login/>} />
