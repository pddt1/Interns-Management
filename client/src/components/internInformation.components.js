...
export default function InternInformation() {
  ...
  function handleUpdate() {
    ...
    //     console.log(value);
    //  }
    UserService.updateIntern(id, formData).then(
      (res) => {
            ...
            <div className="card mb-4">
              <div className="card-body">
                <div className="row" id="row-1">
                  ...
                  <div className="col-sm-6">
                    <input
                      ...
                      value={
                        !editableField[1] ? intern.fullName : backup.fullName
                      }
                  ...
                  <div
                    className="col-sm-3 btnField"
                    style={{ display: editableField[1] && "inline-block" }}
                  >
                    <EditButton
                      id={"1"}
                ...
                <div className="row" id="row-2">
                  ...
                  <div
                    className="col-sm-3 btnField"
                    style={{ display: editableField[2] && "inline-block" }}
                  >
                    <EditButton
                      id={"2"}
                ...
                <div className="row" id="row-3">
                  ...
                  <div
                    className="col-sm-3 btnField"
                    style={{ display: editableField[3] && "inline-block" }}
                  >
                    <EditButton
                      id={"3"}
                ...
                <div className="row" id="row-4">
                  ...
                  <div
                    className="col-sm-3 btnField"
                    style={{ display: editableField[4] && "inline-block" }}
                  >
                    <EditButton
                      id={"4"}
                ...
                <div className="row" id="row-5">
                  ...
                  <div className="col-sm-6">
                    ...
                    <input
                      ...
                      name="startDay"
                      value={
                        !editableField[5] ? intern.startDay : backup.startDay
                      }
                  ...
                  <div
                    className="col-sm-3 btnField"
                    style={{ display: editableField[5] && "inline-block" }}
                  >
                    <EditButton
                      id={"5"}
                ...
                <div className="row" id="row-6">
                  ...
                  <div
                    className="col-sm-3 btnField"
                    style={{ display: editableField[6] && "inline-block" }}
                  >
                    <EditButton
                      id={"6"}
                ...
                <div className="row" id="row-7">
                    ...
                    {!editableField[7] ? (
                      ...
                      <>
                        <input
                          ...
                          onChange={handleInput}
                          value={
                            !editableField[7] ? intern.result : backup.result
                          }
                          name="result"
                  ...
                  <div
                    className="col-sm-3 btnField"
                    style={{ display: editableField[7] && "inline-block" }}
                  >
                    <EditButton
                      id={"7"}
                ...
                <div className="row" id="row-8">
                  ...
                  <div
                    className="col-sm-3 btnField"
                    style={{ display: editableField[8] && "inline-block" }}
                  >
                    <EditButton
                      id={"8"}
